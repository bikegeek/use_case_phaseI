   ...
   if stat_now_name == 'ac':
      ...
      while n <= nexp: #loop over experiments
         ...
         if n == 1:
            ...
            ax2.text(0.0, -0.3, 'Differences outside the outline bars are significant at the 95% confidence interval', fontsize=10, bbox={'facecolor':'white', 'alpha':0, 'pad':5}, transform=ax2.transAxes)
